// -*-c++-*-
// Time-stamp: <2004-04-02 15:46:17 dky>
//-----------------------------------------------------------------------------
// File  : engine.cpp
    ...
    for(SIZE_T tc=0;iter!=l_tci.end();iter++){
        ...
        if(ptc->GroupStatus()||porigtc->PseudoGroupStatus()){
            ...
            if(blocked){
                ...
                tharr[tc]=chBEGINTHREADEX(NULL,0,CreateManagedProcesses,ptc,0,
                                          NULL);
                tc++;
            }
            continue;
        ...
        if(CompKey==COMPKEY_JOBOBJECT){
            ...
            switch(dwBytesXferred){
                ...
                case JOB_OBJECT_MSG_JOB_MEMORY_LIMIT:
                    break;
                default:
                    // fprintf(g_CRAMP_Engine.g_LogFile,
                    //         "%d:Unknown event in Job:%d\n",
